...
server_url = "http://127.0.0.1:5003/upload_image"  # Use your server's URL and port
...
if __name__ == "__main__":
    # File path to the image to be tested (real or fake)
    file_path = "Real.png"  # Example image file
