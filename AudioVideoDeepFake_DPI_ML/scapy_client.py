...
server_url = "http://127.0.0.1:5000/upload"  # Update with your server's URL and port

def upload_file(file_path):
    """
    Function to upload a video file to the server.
    The server will process both video and audio to detect deepfakes.
    """
...
if __name__ == "__main__":
    ...
    file_path = "RealVFakeA.mp4"  # Example video file
